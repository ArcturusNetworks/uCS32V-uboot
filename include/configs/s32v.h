...
#define IMAGE_NAME MPXS32V234/Image
#define BOOT_MTD booti
#else
#define IMAGE_NAME MPXS32V234/uImage
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"ipaddr=192.168.0.100\0" \
	"serverip=192.168.0.38\0" \
	"netmask=255.255.255.0\0" \
	"rootpath=/tftpboot/rootfs-s32v23xx\0" \
	"nfsbootargs=setenv bootargs console=${console},${baudrate} " \
		"root=/dev/nfs rw " \
		"ip=${ipaddr}:${serverip}::${netmask}::eth0:off " \
		"nfsroot=${serverip}:${rootpath},v3,nolock \0" \
